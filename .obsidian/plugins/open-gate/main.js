...
function processNewSyntax(sourceCode) {
  ...
  if (sourceCode.length !== 0) {
    ...
    if (typeof data !== "object" || data === null || Object.keys(data).length === 0) {
      return document.createTextNode("From version 1.10.0, the syntax of gate has changed. You have to use YAML format. Just like Obsidian's front matter. Sorry for the inconvenience.");
    }
    if (data.height) {
